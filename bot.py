...
app = Client(
    ...
    bot_token="6617377767:AAHAoIL9XJ2onDGs0C4YrzB2qQHxlNUCgEY",
)


@app.on_message(filters.command("start") & filters.private & filters.user(1813305809))
async def start(client, message: Message):
    await message.reply_text("Working...")


@app.on_message(filters.command("get") & filters.private & filters.user(1813305809))
...
@app.on_message(filters.command("post") & filters.private & filters.user(1813305809))
